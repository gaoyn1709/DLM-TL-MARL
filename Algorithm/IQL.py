...
class IQL:
    def __init__(self, args):
        ...
        self.n_agents = 10
        self.state_shape = 20
        self.obs_shape = 3     # observation_size gyn
    ...
    def init_hidden(self, episode_num):
        ...
        self.eval_hidden = torch.zeros((episode_num, self.n_agents, self.args.rnn_hidden_dim))  # 1 4   64
        self.target_hidden = torch.zeros((episode_num, self.n_agents, self.args.rnn_hidden_dim))    # 1 4 64
